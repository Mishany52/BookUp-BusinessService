...
export class Auto1722244627028 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "businesses" DROP CONSTRAINT "PK_bc1bf63498dd2368ce3dc8686e8"`);
        ...
        await queryRunner.query(`ALTER TABLE "businesses" ADD CONSTRAINT "PK_bc1bf63498dd2368ce3dc8686e8" PRIMARY KEY ("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "businesses" DROP COLUMN "postIndex"`);
        await queryRunner.query(`ALTER TABLE "businesses" ADD "postIndex" character varying(6) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "businesses" DROP CONSTRAINT "PK_bc1bf63498dd2368ce3dc8686e8"`);
        await queryRunner.query(`ALTER TABLE "businesses" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "businesses" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        await queryRunner.query(`ALTER TABLE "businesses" ADD CONSTRAINT "PK_bc1bf63498dd2368ce3dc8686e8" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "owners" DROP COLUMN "imgUrl"`);
